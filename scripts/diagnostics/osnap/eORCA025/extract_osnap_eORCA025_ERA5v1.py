# ---------------------------------------------------
# extract_osnap_eORCA025_ERA5.py
# 
# Description:
...
def extract_osnap_moc(domain_path: str,
    ...
    print("=== Extracting eORCA025 ERA-5 v1 OSNAP MOC with Dask ===")
...
if __name__ == "__main__":
    ...
    t_paths= sorted(glob.glob("/dssgfs01/scratch/npd/simulations/eORCA025_ERA5_v1/eORCA025_ERA5_1m_grid_T_*.nc"))
    v_paths = sorted(glob.glob("/dssgfs01/scratch/npd/simulations/eORCA025_ERA5_v1/eORCA025_ERA5_1m_grid_V_*.nc"))
    u_paths = sorted(glob.glob("/dssgfs01/scratch/npd/simulations/eORCA025_ERA5_v1/eORCA025_ERA5_1m_grid_U_*.nc"))
