...
parser.add_argument('-v','--variables', help='List of ERA-5 variables to download.', required=False, nargs='+', default=['2m_temperature', '2m_dewpoint_temperature','10m_u_component_of_wind', '10m_v_component_of_wind', 'mean_total_precipitation_rate', 'mean_sea_level_pressure', 'mean_eastward_turbulent_surface_stress', 'mean_northward_turbulent_surface_stress', 'mean_surface_latent_heat_flux','mean_surface_sensible_heat_flux', 'mean_surface_net_long_wave_radiation_flux', 'mean_surface_net_short_wave_radiation_flux', 'sea_ice_cover', 'sea_surface_temperature'])
