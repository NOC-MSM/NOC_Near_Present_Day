...
# python3 download_ERA5_forcing.py --year ${year} --savedir ${savedir} --latestdir ${latestdir} --variables ${variables} || { echo "Error: Downloading ERA-5 atmospheric forcing data failed..."; exit 1; }
