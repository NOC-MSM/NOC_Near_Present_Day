...
# ==============================================================
# rebuild_eORCA1_ocean_restarts.slurm
#
# Description: Script to rebuild NPD-eORCA1-ERA5v1 ocean restart
...
for restart_file in $restart_files; do
    ...
    # Move rebuilt ocean restart file to NPD restarts directory:
    if [[ $n -lt 2 ]]; then
