...
# ==============================================================
# rebuild_eORCA12_ocean_restarts.slurm
#
# Description: Script to rebuild NPD-eORCA12-ERA5v1 ocean restart
# files from tiles in the RESTART/ directory.
#
...
cd $restart_dir
restart_files=$(find eORCA1_ERA5_*_restart_0000.nc)
